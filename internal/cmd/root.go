...
// compatibility, latency, throughput, cache, soak, and list subcommands.
package cmd
...
func NewRoot() *cobra.Command {
	...
	root.AddCommand(newCompatibilityCmd(), newLatencyCmd(), newThroughputCmd(), newCacheCmd(), newSoakCmd(), newListCmd())
	return root
}
